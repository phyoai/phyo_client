...
const FormContainer = ({ steps, theme = 'brand' }) => {
  ...
  // CheckLine if user has already submitted a registration
  ...
  const initiateRegistration = async (data) => {
    ...
    // CheckLine if already submitted before proceeding
  ...
  const onSubmit = async (data) => {
    ...
    if (currentStep < steps.length - 1) {
      ...
      for (const field of requiredFields) {
        ...
        // CheckLine if field is empty or invalid
        let isEmpty = false;
  ...
  return (
    <FormProvider {...methods}>
      <div className="h-screen flex flex-col bg-neutral-base">
        {/* Fixed App Bar */}
        <div className="bg-neutral-base flex items-center justify-between px-1 py-2 shrink-0 border-b border-gray-200">
          {/* Back Button */}
          <button
            type="button"
            onClick={() => {
        ...
        {registrationSuccess ? (
          ...
          <>
            ...
            <div className="bg-neutral-base px-9 py-4 shrink-0">
            ...
            <div className="bg-neutral-base px-9 py-4 shrink-0 border-t border-gray-200">
