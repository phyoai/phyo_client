...
const UserProfile = memo(({
  ...
  const userType = propUserType || user?.type || 'UserLine';
    ...
    <div className="relative">
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-52 bg-neutral-base rounded-xl shadow-xl border border-gray-100 py-2 z-10">
          <a href={settingsLink} className="block px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 transition-colors">
            Profile MailSettingsLine
          </a>
          <a href={accountLink} className="block px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 transition-colors">
            Account
          </a>
