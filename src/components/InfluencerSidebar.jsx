...
const InfluencerSidebar = () => {
  ...
  const mainNavItems = [
    { name: 'Home',     href: '/influencer/dashboard', iconActive: Home4Fill,         iconDefault: Home4Line },
    { name: 'Inbox',    href: '/influencer/inbox',     iconActive: InboxLine,          iconDefault: InboxLine,         badge: 3 },
    { name: 'Campaign', href: '/influencer/campaigns', iconActive: CalendarEventFill,  iconDefault: CalendarEventLine },
  ];

  const accountSubItems = [
    { name: 'Profile',             href: '/influencer/account',                  icon: User3Line },
    { name: 'My List',             href: '/influencer/account/my-lists',          icon: Heart3Line },
    { name: 'Transactions',        href: '/influencer/account/billing-history',   icon: BankCardLine },
    ...
    { name: 'Privacy Policy',      href: '/influencer/account/privacy-policy',    icon: LockLine },
