...
import { ArrowLeftLineBellLineMoreLineCheckLineCloseLineArrowRightLine } from '@phyoofficial/phyo-icon-library'; 
              ...
              <div className="flex items-center py-3">
                ...
                <div className="flex items-center gap-2 px-4">
                  {notification.hasActions && (
                    <>
                      ...
                      <button className="p-3 hover:bg-red-50 rounded-full transition-colors">
                        <TwitterXLineXLineXLine className="h-6 w-6 text-[#bf3709]" />
                      </button>
                    </>
                  )}
                  ...
                  {notification.hasChevron && (
                    <ArrowRightSLine className="h-6 w-6 text-[#6c6d6e]" />
                  )}
                </div>
              </div>
            </div>
