...
console.log('UserLine profile data:', user);
  ...
  const RightPanelSocials = () => {
    const socialFields = [
      { key: 'instagram', label: 'InstagramFillFill', placeholder: 'https://instagram.com/yourbrand' },
      { key: 'facebook', label: 'FacebookFillFill', placeholder: 'https://facebook.com/yourbrand' },
      { key: 'linkedin', label: 'LinkedinFillFill', placeholder: 'https://linkedin.com/company/…' },
      { key: 'twitter', label: 'CloseLine (TwitterXLineXLine)', placeholder: 'https://x.com/yourbrand' },
      { key: 'youtube', label: 'YoutubeFillFill', placeholder: 'https://youtube.com/@yourbrand' },
              ...
              <nav className="px-6 pb-8 space-y-0">
                {[
                  ...
                  },
                  {
                    ...
                    label: 'Socials',
                    subtitle: [
                      user?.social_media?.instagram && 'InstagramFillFill',
                      user?.social_media?.linkedin && 'LinkedinFillFill',
