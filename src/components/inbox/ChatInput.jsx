...
import { PaperclipLineSmileLineSendPlane2Fill } from '@phyoofficial/phyo-icon-library'; 
      ...
      {showAttachments && (
        <div className="mb-4 bg-neutral-base border border-gray-200 rounded-lg shadow-lg p-2 w-48">
          ...
          >
            ...
            <span className="text-sm text-gray-700">VideoLine</span>
          </button>
      ...
      <form onSubmit={handleSubmit} className="flex items-end space-x-2">
        <div className="flex-1 relative">
          ...
          <div className="absolute right-2 top-1/2 transform -translate-y-1/2 flex items-center space-x-1">
            ...
            >
              <AttachmentLine className="h-5 w-5" />
            </button>
            <button
              type="button"
              className="p-1 text-gray-400 hover:text-gray-600 transition-colors"
            >
              <ChatSmileLine className="h-5 w-5" />
            </button>
          </div>
        </div>
        ...
        <button
          ...
          className={`${buttonColor} ${buttonTextColor} p-3 rounded-lg disabled:opacity-50 disabled:cursor-not-allowed transition-colors`}
        >
