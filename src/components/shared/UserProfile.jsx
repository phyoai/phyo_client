...
const UserProfile = ({ user: propUser, role = 'brand' }) => {
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <span className="text-gray-900 font-semibold text-base">{displayName}</span>
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-52 bg-white rounded-xl shadow-xl border border-gray-100 py-2 z-10">
          <a href={`/${role}/settings`} className="block px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 transition-colors">
            Profile Settings
          </a>
          <a href={`/${role}/account`} className="block px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 transition-colors">
            Account
          </a>
