...
const NavRail = ({
  ...
  return (
    <div
      className={`h-screen fixed left-0 top-0 flex flex-col transition-all duration-300 ease-in-out z-50 ${isExpanded
    ...
    >
      ...
      <div
        className={`flex flex-col gap-[8px] mb-[24px] transition-all duration-300 ease-in-out ${isExpanded ? 'px-[8px]' : 'px-[8px] items-center'
          }`}
      >
        {/* Toggle Button */}
        <button
