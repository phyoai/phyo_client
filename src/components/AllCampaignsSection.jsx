...
import { ArrowLeftLine, ArrowRightSLine, CloseLine, UploadLine, CalendarLine, CheckLine, UserLine, MoreLine, DeleteBinLine, EditLine, SearchLine, HeartLine, ArrowUpLine } from '@phyoofficial/phyo-icon-library';
...
const AllCampaignsSection = () => {
  ...
  useEffect(() => {
    const fetchInfluencers = async () => {
      ...
      try {
        const response = await influencerAPI.getInfluencers({ page: 1, limit: 6 });
            ...
            {productImage && !imageError ? (
              <>
                ...
                <img 
                  ...
                  onError={(e) => {
                    console.error('ImageLine failed to load:', productImage);
                    setImageError(true);
        ...
        return (
          <div className="space-y-6">
            ...
            <div>
              ...
              >
                <UploadLine className="w-8 h-8 text-gray-400 mx-auto mb-2" />
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500"
                placeholder="InstagramFillFill/YouTube"
              />
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="mt-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {influencers.length > 0 ? influencers : mockInfluencers.map((influencer) => (
      ...
      <div className="flex-1 overflow-y-auto px-4 sm:px-6 lg:px-9 py-4 sm:py-6">
              ...
              {loading ? (
                ...
                campaigns.map((campaign) => (
                  ...
                  >
                    ...
                    {/* Content Frame with Avatar and InformationLine */}
                ...
                {loading ? (
                  ...
                  getActiveCampaigns().slice(0, 3).map((campaign) => (
                    ...
                    >
                      ...
                      {/* Campaign ImageLine - Figma: h-216px */}
                      <div className="h-[216px] bg-gradient-to-br from-green-700 to-green-900 relative overflow-hidden">
                        {campaign.productImages && campaign.productImages.length > 0 ? (
                          <img 
                            src={campaign.productImages[0]} 
        ...
        <div className="mb-10">
          ...
          <div className="bg-neutral-base">
            {influencers.length > 0 ? influencers : mockInfluencers.slice(0, 5).map((influencer, index) => (
              <div key={influencer.id} className="relative">
                ...
                {index < influencers.length > 0 ? influencers : mockInfluencers.slice(0, 5).length - 1 && (
          ...
          <div className="bg-neutral-base rounded-lg max-w-4xl w-full max-h-[90vh] overflow-hidden">
            ...
            <div className="px-6 py-4 border-b border-gray-200">
              <div className="flex items-center justify-between">
                ...
                >
                  <TwitterXLineXLineXLine className="w-6 h-6" />
                </button>
              </div>
