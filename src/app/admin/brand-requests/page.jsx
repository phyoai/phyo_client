...
import { AlertCircle, ArrowLeft, Check, X, Clock, FileText } from 'lucide-react';
  ...
  useEffect(() => {
    const fetch = async () => {
      try {
        ...
        setError(err?.message || 'Failed to load brand requests');
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Brand Requests</h1>
          <p className="text-gray-600 dark:text-gray-400">Review and manage pending brand approval requests</p>
        </div>
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <div className="flex items-center gap-3 mb-2">
                            <h3 className="font-semibold text-gray-900 dark:text-white text-lg">{data?.brandName}</h3>
                          ...
                          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-3">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-gray-900 dark:text-white font-medium">{data?.phone || 'N/A'}</p>
                            </div>
                            <div>
