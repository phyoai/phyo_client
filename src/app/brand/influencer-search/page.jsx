    ...
    return (
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          {/* ── NAME + INFO — indented past avatar ── */}
          <div className="px-5 pt-2 pb-4" style={{ paddingLeft: 144, paddingTop: 10 }}>
            <div className="flex items-center gap-2 mb-1 flex-wrap">
              ...
              <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[11px] font-semibold" style={{ background: '#0a4620', color: '#16A34A' }}>
                <span className="w-1.5 h-1.5 rounded-full bg-[#16A34A] inline-block" />verified
              </span>
            </div>
            <p className="text-[13px]" style={{ color: 'rgba(255,255,255,0.55)', fontFamily: 'Inter, sans-serif' }}>{profile.username} · {profile.location}</p>
          </div>
