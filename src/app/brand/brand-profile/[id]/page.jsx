        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="bg-[#1a1a1a] rounded-2xl p-6">
              ...
              <div className="bg-[#262625] rounded-2xl p-5">
                <p
                ...
                <p
                  className="text-[#9B9B9B] text-[16px]"
              ...
              <div className="bg-[#262625] rounded-[24px] p-6 mt-2">
                <h4
                  className="text-white text-[20px] font-semibold mb-6"
                  style={{ fontFamily: 'var(--font-bricolage-grotesque)' }}
                >
                  Age groups
                </h4>
                ...
                <div className="flex h-[260px]">
                  ...
                  <div className="flex flex-col justify-between text-[#E5E5E5] text-sm pr-4">
                    <span>100%</span>
                    <span>80%</span>
                    <span>60%</span>
                    <span>40%</span>
                  ...
                  {/* Chart */}
                  <div className="flex-1 flex items-end justify-around border-l border-[#3A3A3A] pl-4">
                    {brand.performance.ageGroups.map((group, i) => (
                      <div key={i} className="flex flex-col items-center gap-3">
                        <div
                          className="w-10 bg-[#0A7D2C] rounded-t-xl"
                          style={{
                            height: `${(group.value / 100) * 200}px`,
                          }}
                        />
                        <p
                          className="text-[#E5E5E5] text-[13px]"
                          style={{ fontFamily: 'Inter,sans-serif' }}
                        >
                          {group.range}
                        </p>
