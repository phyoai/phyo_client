    ...
    return (
        <div className='relative'>
            ...
            <h1 className="text-[32px] sm:text-[34px] items-center text-[#312F39] mx-auto text-center font-bold relative">
                Phyo: World's Only Influencer SearchLine Engine
            </h1>
            <h2 className='text-[28px] font-medium text-center'>SearchLine Influencers in Seconds</h2>
            ...
            <div className="flex items-center mt-[75px] justify-center mx-[10px]">
                <div className="flex items-center justify-between w-full max-w-4xl border-2 border-green-700 rounded-full p-2 bg-neutral-base">
            ...
            <Image2Line src={"/star1.png"} width={60} height={60} alt='star' className='hidden sm:block absolute top-[20%] left-[15%]' />
            <Image2Line src={"/star2.png"} width={50} height={50} alt='star' className='absolute sm:bottom-[20%] sm:right-[5%] left-[5%] top-[-10%]' />
