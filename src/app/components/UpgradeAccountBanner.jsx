      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <div className="bg-neutral-base/20 rounded-full p-2">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="flex space-x-2">
              <motion.button
                ...
                className="bg-neutral-base text-green-600 hover:bg-gray-100 px-4 py-2 rounded-lg font-semibold text-sm transition-colors duration-200"
              >
                Join as Brand
              </motion.button>
              ...
              <motion.button
                ...
                className="bg-transparent border-2 border-white text-white hover:bg-neutral-base hover:text-green-600 px-4 py-2 rounded-lg font-semibold text-sm transition-all duration-200"
              >
                Join as Influencer
              </motion.button>
            </div>
        ...
        >
          <div className="pt-6 border-t border-white/20 mt-4">
            <div className="grid md:grid-cols-2 gap-6">
              {/* Brand Benefits */}
              <div className="bg-neutral-base/10 rounded-xl p-4 backdrop-blur-sm">
                <h4 className="text-lg font-bold mb-3 flex items-center">
                  <span className="bg-neutral-base/20 rounded-lg p-2 mr-3">
