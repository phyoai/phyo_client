                ...
                <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6 min-w-0">
                  ...
                  <div className="flex-1 min-w-0 w-full break-words">
                    ...
                    <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 pt-2">
                      <button 
                        className="flex items-center justify-center gap-2 px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors font-medium shadow-sm text-sm"
                        onClick={(e) => {
                          e.stopPropagation();
                      ...
                      {(influencer.instagramData?.link || influencer.brightDataProfile?.profile_url) && (
                        <a 
                          ...
                          className="flex items-center justify-center gap-2 px-4 py-2 border border-green-600 text-green-600 rounded-lg hover:bg-green-50 transition-colors font-medium shadow-sm text-sm"
