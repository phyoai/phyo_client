              ...
              <div className="py-6 text-gray-700">
                {activeTab === "overview" && (
                  <div className="space-y-8">
                            ...
                            <div className="flex flex-col items-start gap-4 px-6 py-6 self-stretch">
                              ...
                              <button
                                onClick={() => {
                                  ...
                                  router.push('/user/campaigns/influencer-counter-offer');
                                }}
                          ...
                          <div className="">
                            <div className="flex flex-col items-start gap-4 px-6 py-6 self-stretch h-full">
                              ...
                              <button
                                onClick={() => {
                                  setResponded(!responded);
                                  router.push('/user/campaigns/influencer-detail-deliverables');
                                }}
                    ...
                    <div className="border-2 border-gray-300 rounded-2xl bg-gradient-to-r from-green-700 to-green-600 p-8 cursor-pointer" onClick={() => router.push('/user/campaigns/boost-campaign')}>
                    ...
                    <div className="flex gap-3 w-full">
                      <button className="flex-1 px-6 py-3 bg-green-100 hover:bg-green-200 text-green-700 rounded-full font-semibold text-sm flex items-center justify-center gap-2 transition-colors" onClick={() => router.push('/user/campaigns/campaign-summary')}>
