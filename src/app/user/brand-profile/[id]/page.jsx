...
export default function BrandProfile() {
  ...
  if (!brand) return (
    <div className="min-h-screen bg-[#000201] flex items-center justify-center text-white">
      Loading...
    </div>
  );
  ...
  return (
    <div className="min-h-screen bg-[#000201] py-6 pb-24">
      <div className="w-full flex flex-col gap-6">

        {/* ── HERO BANNER + AVATAR ── */}
        <div className="relative">
          <div
            className="w-full h-[260px] rounded-3xl overflow-hidden"
          ...
          >
            <span
              ...
              style={{ fontFamily: 'var(--font-bricolage-grotesque)', fontSize: 56 }}
            >
              {initial}
            </span>
          </div>
          ...
          <div className="absolute top-4 right-4 flex gap-2 z-10">
            <button
              ...
              style={{ background: 'rgba(0,0,0,0.45)', backdropFilter: 'blur(6px)', border: 'none', cursor: 'pointer' }}
            >
        ...
        <div className="flex flex-col gap-3" style={{ paddingTop: 12, paddingLeft: 196 }}>
          <div className="flex items-center gap-3 flex-wrap">
            <h1
              ...
              style={{ fontFamily: 'var(--font-bricolage-grotesque)', letterSpacing: '-0.01em' }}
            >
              {brand.name}
            </h1>
            {brand.verified && (
          ...
          <p className="text-[15px] text-[#9A9A9A]" style={{ fontFamily: 'Inter,sans-serif' }}>
            {brand.location} · {brand.followers} followers
          </p>
        ...
        <div className="bg-[#1a1a1a] rounded-2xl p-6">
          ...
          <p className="text-[#9A9A9A] text-[15px] leading-relaxed" style={{ fontFamily: 'Inter,sans-serif' }}>
            {brand.about}
          </p>
        </div>
              ...
              {brand.activeCampaigns.map((campaign) => (
                <div key={campaign.id} className="bg-[#262625] rounded-3xl p-5 min-h-[280px] flex flex-col">
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <span
                      className="px-3 py-1 rounded-full text-[12px] font-semibold bg-[#0a4620] text-[#16A34A]"
                      style={{ fontFamily: 'Inter,sans-serif' }}
                    >
                      {campaign.status}
                    </span>
                  ...
                  <div className="space-y-2 mb-3">
                    <div
                      className="flex items-center gap-2 text-[13px] text-[#9B9B9B]"
                      style={{ fontFamily: 'Inter,sans-serif' }}
                    >
                  ...
                  <div className="flex gap-2 mb-3">
                    {[
                      { label: `${campaign.contentTypes.reels} Reels` },
                      { label: `${campaign.contentTypes.stories} Stories` },
                      { label: `${campaign.contentTypes.posts} Post` }
                    ].map((ct, i) => (
                      <span
                        key={i}
                        className="border border-[#9B9B9B] text-[#9B9B9B] px-3 py-1 rounded-full text-[11px]"
                        style={{ fontFamily: 'Inter,sans-serif' }}
                      >
                        {ct.label}
                      </span>
                  ...
                  <div className="flex items-center justify-between mt-auto">
                    <div>
                      ...
                      <div className="flex items-center gap-2 text-[12px] mt-1">
                        <span className="text-[#ff4444]" style={{ fontFamily: 'Inter,sans-serif' }}>
                          {campaign.daysLeft} days left
                        </span>
                        <span className="text-[#9B9B9B]" style={{ fontFamily: 'Inter,sans-serif' }}>
                          | {campaign.spotsOpen} spots open
                        </span>
                      </div>
                    </div>
                    <button
                      className="bg-[#16A34A] hover:bg-[#15803d] text-white px-6 py-2 rounded-full font-semibold transition"
                      style={{ fontFamily: 'Inter,sans-serif' }}
                    >
                      Apply Now
                    </button>
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="bg-[#1a1a1a] rounded-2xl p-6">
              ...
              <div className="grid grid-cols-2 gap-3 mb-6">
                <div className="bg-[#262625] rounded-xl p-4">
                  <p
                    className="text-[24px] font-bold text-white"
                    style={{ fontFamily: 'var(--font-bricolage-grotesque)' }}
                  >
                    {brand.performance.campaignsRun}
                  </p>
                  <p className="text-[#9B9B9B] text-[12px]" style={{ fontFamily: 'Inter,sans-serif' }}>
                    Campaigns Run
                  </p>
                </div>
                <div className="bg-[#262625] rounded-xl p-4">
                  <p
                    ...
                    style={{ fontFamily: 'var(--font-bricolage-grotesque)' }}
                  >
                    {brand.performance.avgEngagement}
                  </p>
                  <p className="text-[#9B9B9B] text-[12px]" style={{ fontFamily: 'Inter,sans-serif' }}>
                    Avg Engagement
                  </p>
                ...
                <div className="bg-[#262625] rounded-xl p-4">
                  <p
                    ...
                    style={{ fontFamily: 'var(--font-bricolage-grotesque)' }}
                  >
                    {brand.performance.creatorSatisfaction}
                  </p>
                  <p className="text-[#9B9B9B] text-[12px]" style={{ fontFamily: 'Inter,sans-serif' }}>
              ...
              {/* Age Groups Card — FIXED */}
              <div className="bg-[#262625] rounded-[24px] p-6">
                <h4
                ...
                <div className="flex h-[200px]">
                  {/* Y-axis labels */}
                  <div
                    className="flex flex-col justify-between text-[#9B9B9B] text-[11px] pr-3 pb-5"
                    style={{ fontFamily: 'Inter,sans-serif' }}
                  >
                    <span>100%</span>
                    <span>80%</span>
                  ...
                  {/* Bars */}
                  <div className="flex-1 flex items-end justify-around gap-1 border-l border-[#3A3A3A] pl-2 pb-5">
                    {brand.performance.ageGroups.map((group, i) => (
                      <div key={i} className="flex flex-col items-center gap-2 flex-1">
                        <div
                          className="w-full max-w-[28px] bg-[#16A34A] rounded-t-md"
                          style={{ height: `${(group.value / maxHeight) * 140}px` }}
                        />
                        <p
                          className="text-[#9B9B9B] text-[9px] text-center"
                          style={{ fontFamily: 'Inter,sans-serif' }}
                        >
                          {group.range}
                        </p>
            ...
            <div className="bg-[#1a1a1a] rounded-2xl p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <a href="#" className="text-[#16A34A] text-[14px]" style={{ fontFamily: 'Inter,sans-serif' }}>
                  View All →
                </a>
              </div>
              <div className="space-y-3">
                {brand.connectedPlatforms.map((platform) => (
                  <div
                    key={platform.id}
                    className="bg-[#262625] rounded-2xl p-4 flex items-center justify-between"
                  >
                    <div className="flex items-center gap-3">
                      <div className="w-12 h-12 rounded-full bg-gradient-to-br from-orange-300 to-red-400 flex-shrink-0" />
                      <div>
                        <p
            ...
            <div>
              <div className="flex items-center gap-3 mb-2">
                ...
                <div className="flex gap-1">
                  {[...Array(5)].map((_, i) => (
                    <span key={i} className="text-[20px]">⭐</span>
                  ))}
                </div>
              </div>
              <p className="text-[#9B9B9B] text-[13px]" style={{ fontFamily: 'Inter,sans-serif' }}>
                {brand.reviews.count} Brand Reviews
              </p>
            </div>
            <a href="#" className="text-[#16A34A] text-[14px]" style={{ fontFamily: 'Inter,sans-serif' }}>
              View All →
          ...
          <div className="space-y-4">
            {brand.reviews.items.map((review, i) => (
              <div key={i} className="bg-[#262625] rounded-2xl p-4">
                ...
                <p
                  className="text-[#9B9B9B] text-[13px] leading-relaxed"
                  style={{ fontFamily: 'Inter,sans-serif' }}
                >
                  "{review.review}"
                </p>
