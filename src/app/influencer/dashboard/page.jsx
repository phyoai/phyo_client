...
function DashboardContent() {
  ...
  const handleSearchClick = () => {
    setIsFadingOut(true);
    setTimeout(() => router.push('/influencer/influencer-search'), 300);
  };
      ...
      <div className={`min-h-screen bg-[#000201] text-white transition-all duration-300 ${isFadingOut ? 'fade-out-dashboard' : ''}`}>
        <div className="px-4 sm:px-6 lg:px-8 pt-6 pb-10">
          ...
          <div className="flex flex-col gap-[32px]">
            ...
            {/* Top Influencers */}
            <div>
              <SectionHeading title="Top Influencers" onViewAll={() => router.push('/influencer/influencers')} />
              {influencersLoading ? (
                ...
                <div className="flex gap-[20px] overflow-x-auto pb-2 scrollbar-hide">
                  {topInfluencers.map((inf, index) => (
                    <InfluencerAvatar
                      ...
                      onClick={() => router.push(`/influencer/influencers/${inf._id || inf.id}`)}
                    />
                  ))}
                </div>
              ) : (
            ...
            {/* Top Campaigns */}
            <div>
              <SectionHeading title="Top Campaigns" onViewAll={() => router.push('/influencer/campaigns')} />
                  ...
                  {topCampaigns.length > 0 ? topCampaigns.map((campaign, index) => {
                    ...
                    return (
                      <CampaignCard
                        ...
                        onClick={() => router.push(`/influencer/campaigns/${id}`)}
                      />
                    );
                  }) : (
            ...
            <div className="bg-[#181818] rounded-[24px] p-5 border border-white/5">
              <div className="flex items-start justify-between mb-5">
                ...
                <button
                  onClick={() => router.push('/influencer/explore-brands')}
                  ...
                  {exploreBrands.map((brand, index) => {
                    ...
                    return (
                      <div
                        ...
                        onClick={() => router.push(`/influencer/brand-profile/${brand._id || brand.id}`)}
                      >
            ...
            {/* Nearby Campaigns */}
            <div>
              <SectionHeading title="Nearby Campaigns" onViewAll={() => router.push('/influencer/campaigns')} />
              <div className="flex gap-3 items-center mb-5 flex-wrap">
                {CATEGORIES.map((cat) => (
                  <button
                    key={cat}
            ...
            >
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <button
                  onClick={() => router.push('/influencer/learn-more')}
