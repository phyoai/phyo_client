...
const AllCampaignsSection = () => {
  ...
  React.useEffect(() => {
    ...
    setSidebarButtonAction(() => () => {
      window.location.href = '/influencer/campaigns/create-campaign';
    });
      ...
      <div className="flex-1 overflow-y-auto px-4 sm:px-6 lg:px-9 py-4 sm:py-6">
          ...
          <>
            ...
            <div className="mb-10">
              ...
              <div className="flex items-center justify-between pt-4 mb-[14px]">
                ...
                <button 
                  onClick={() => router.push('/influencer/campaigns/all-campaigns')}
        ...
        <div className="mb-10">
          ...
          <div className="flex items-center justify-between pt-4 mb-[14px]">
            ...
            <button 
              onClick={() => router.push('/influencer/campaigns/new-applications')}
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            ...
            <button 
              onClick={() => router.push('/influencer/campaigns/all-drafts')}
