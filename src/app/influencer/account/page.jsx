      ...
      <div className="flex-1 overflow-y-auto px-4 sm:px-6 lg:px-9 py-4 sm:py-6 dark:bg-[#121212]">
        ...
        <div className="mb-6">
          <div className="bg-white dark:bg-[#1e1e1e] rounded-2xl overflow-hidden border border-[#e6e6e6] dark:border-gray-700">
            ...
            <button className="w-full" onClick={() => router.push('/influencer/account/my-lists')}>
              <MenuItem icon={ListUnordered} label={t('my_lists')} />
              <div className="h-px bg-[#e6e6e6] dark:bg-gray-700 mx-4"></div>
            </button>
            <button className="w-full" onClick={() => router.push('/influencer/account/billing-history')}>
              <MenuItem icon={FileList3Line} label={t('transactions')} />
              <div className="h-px bg-[#e6e6e6] dark:bg-gray-700 mx-4"></div>
            </button>
            <button className="w-full" onClick={() => router.push('/influencer/account/upgrade-plan')}>
            ...
            <button className="w-full" onClick={() => router.push('/influencer/account/notifications-preferences')}>
            ...
            <button className="w-full" onClick={() => router.push('/influencer/account/help-support')}>
