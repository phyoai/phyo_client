...
function VoiceCard() {
  return (
    <article className="relative min-h-[220px] overflow-hidden rounded-[23px] bg-[#141414] px-8 pb-5 pt-5">
      <div className="pointer-events-none absolute left-8 top-5 h-20 w-px bg-[#16a34a]" />

      <div className="pb-16 pl-5 pr-2">
        {[0, 1, 2].map((line) => (
          <div
            key={line}
            className={line > 0 ? "mt-3 border-t border-white/10 pt-3" : ""}
          >
  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute inset-x-0 top-0 h-[1100px]">
        ...
        <div className="absolute left-1/2 top-[-180px] h-[560px] w-[560px] -translate-x-1/2 rounded-full bg-[#0d3b19]/10 blur-3xl" />
      </div>
